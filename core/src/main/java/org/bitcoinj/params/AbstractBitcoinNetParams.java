 ...
 */
 public abstract class AbstractKomodoMainNetParams extends NetworkParameters {

     /**
      * Scheme part for Bitcoin URIs.
      */
     public static final String BITCOIN_SCHEME = "komodo";
     public static final int REWARD_HALVING_INTERVAL = 840000;

     private static final Logger log = LoggerFactory.getLogger(AbstractKomodoMainNetParams.class);

     public AbstractKomodoMainNetParams() {
         super();
     }
